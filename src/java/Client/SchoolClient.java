...
public class SchoolClient {
    ...
    public void updateStudent(String studId, String studentName, String stdId) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updateStudent/{0}/{1}/{2}", new Object[]{studId, studentName, stdId})).request().put(empty);
    }
    ...
    public void updateStd(String stdId, String stdName) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updateStd/{0}/{1}", new Object[]{stdId, stdName})).request().put(empty);
    }
    ...
    public void updateTeacher(String teacherId, String teacherName) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updateTeacher/{0}/{1}", new Object[]{teacherId, teacherName})).request().put(empty);
    }
